...
// onto Status/WaitingFor and overlays shell from an open updates.jsonl
// background task. A grok row that still has neither (no log, torn read,
// no open background) takes the same "-" placeholder MODEL, TMUX and SID
// already use.
